object ManageEmployees: TManageEmployees
  Left = 0
  Top = 0
  Width = 913
  Height = 575
  ...
  object btnShowResigned: TButton
    Left = 219
    Top = 3
    Width = 94
    Height = 21
    Caption = 'Show Resigned'
    TabOrder = 4
    OnClick = btnShowResignedClick
  end
